        ...
        <div class="div3"></div> -->
            ...
            <div class="div3">
                ...
                <div class="function">
                    ...
                    <div class="div22">
                        <ul>
                            <li class="button1"><a href="victim.php" target="blank">Continue as a victim/junior</a></li>
                            <li class="button2"><a href="authority3.php">Continue as a Authority</a></li>
                            <li class="button3"><a href="public.php">Continue as a Public/Reader</a></li>
                        </ul>
                    </div>
